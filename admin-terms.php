...
<div class="container">
    ...
    <ul>
        <li><strong style="color:#22c55e;">SECASA Admin: </strong> These admins can send emails to all members across various groups within SECASA. This includes important announcements or upcoming event reminders.</li>
        <li><strong style="color:#4A90E2;">Group Admin: </strong> These admins can send emails to the members of their specific group only. Group admins handle more focused, group-specific communications.</li>
    </ul>
    <p>
...
<script>
    ...
    function proceedAsAdmin(adminType) {
        ...
        if (adminType === 'SECASA') {
            ...
            window.location.href = 'admins-page.php'; // Redirect to Group Admin login
        }
    }
</script>
