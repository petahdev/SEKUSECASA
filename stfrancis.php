...
<body>
    ...
    <div class="landing-content">
        <h1 class="heading">Welcome to St. Francis Community</h1>
    </div>
    <main onclick="closeSidebar()">
        <section class="landing">
            <h2>Saint Francis asks you to join them</h2>
            <p>Get to join our vibrant St Francis Jumuiya.</p>
        </section>

        <section class="group-form">
            <h3>Register for St Francis Community</h3>
    ...
    <p style="text-align:center;"><a style="text-decoration:none; color:#22c55e;" href="st-francis-sucess.php">Subscribe to St Francis Reminders</a></p>
