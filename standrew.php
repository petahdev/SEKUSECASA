...
<body>
    ...
    <div class="landing-content">
        <h1 class="heading">Welcome to St. Andrew Community</h1>
    </div>
    <main onclick="closeSidebar()">
        <section class="landing">
            <h2>St. Andrew Registration</h2>
            <p>Join St Andrew Jumuiya and learn who they are, and what they do.</p>
        </section>

        <section class="group-form">
            <h3>Register for SECASA Groups</h3>
            <form action="standrew-register.php" method="POST" enctype="multipart/form-data">
    ...
    <p style="text-align:center;"><a style="text-decoration:none; color:#22c55e;" href="st-andrew-success.php">Subscribe to St Andrew Reminders</a></p>
