...
function sendEmailToAll($recipients, $name, $position, $message) {
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = "New Admin Message from SECASA (Choir)";
        $mail->Body    = "
        ...
        $mail->send();
        echo "<div style='color: green; text-align:center;'>Message sent successfully to Choir members!</div>";
    } catch (Exception $e) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($recipients)) {
        ...
        echo "<div style='color: red; text-align:center;'>No emails found for Choir members.</div>";
    }
}
