...
<body>
    ...
    <div class="landing-content">
        <h1 class="heading">Welcome to St. Monica Community</h1>
    </div>
    <main onclick="closeSidebar()">
        <section class="landing">
            <h2>St. Monica Jumuiya</h2>
            <p>Join us as we lead to serve The Lord.</p>
        </section>

        <section class="group-form">
            <h3>Register for SECASA Groups</h3>
            <form action="stmonica-register.php" method="POST" enctype="multipart/form-data">
    ...
    <p style="text-align:center;"><a style="text-decoration:none; color:#22c55e;" href="st-monica-success.php">Subscribe to St Monica Reminders</a></p>
