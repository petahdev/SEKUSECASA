...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO cma (first_name, second_name, surname, email, phone_number, course_done, year_of_study, password, image)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($insertStmt->execute()) {
            header("Location: cma-success.php"); // Redirect to a success page
            exit;
        } else {
