...
if (isset($_POST['subscribe'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO choir (email, phone_number, password) VALUES (?, ?, ?)");
...
function sendWeeklyReminders() {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $morningSubject = 'Reminder: Choir Meeting Today at 7:30 PM';
        $morningBody = "
        <h1>Good Morning!</h1>
