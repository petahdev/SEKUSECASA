...
<head>
    ...
    <title>Pioneer Membership</title>
...
<body>
    ...
    <div class="landing-content">
        <h1 class="heading">Welcome to The Secasa Pioneers</h1>
    </div>
    <main onclick="closeSidebar()">
        <section class="landing">
            <h2>Secasa Pioneer Registration</h2>
            <p>Join the Pioneers today.</p>
        </section>

        <section class="group-form">
            <h3>Register for the Choir here</h3>
            <form action="pioneer-register.php" method="POST" enctype="multipart/form-data">
    ...
    <p style="text-align:center;"><a style="text-decoration:none; color:#22c55e;" href="success.php">Subscribe to Pioneer Reminders</a></p>
