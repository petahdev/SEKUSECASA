...
<body>
    ...
    <div class="landing-content">
        <h1 class="heading">Welcome to St. Augustine Community</h1>
    </div>
    <main onclick="closeSidebar()">
        <section class="landing">
            <h2>St Augustine Jumuiya invites you to be part of them</h2>
            <p>Learn more about St Augustine Jumuiya, and Join us.</p>
        </section>

        <section class="group-form">
            <h3>Register for SECASA Groups</h3>
            <form action="staugustine-register.php" method="POST" enctype="multipart/form-data">
    ...
    <p style="text-align:center;"><a style="text-decoration:none; color:#22c55e;" href="st-augustine-sucess.php">Subscribe to St. Augustine Reminders</a></p>
