...
body {
    ...
    background: url('images/rosary2.jpg') no-repeat center center fixed; 
...
<body>
    ...
    <section class="landing">
        <h2>Come Lets Follow Christ</h2>
        <p>Come lets Proclaim the Lord</p>
    </section>

    <section class="group-form">
        <h3>Register for the Secasa Pioneers</h3>
        ...
        <form action="choiremail.php" method="POST">
