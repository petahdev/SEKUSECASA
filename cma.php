...
<body>
    ...
    <div class="landing-content">
        <h1 class="heading">Welcome to CMA</h1>
    </div>
    <main onclick="closeSidebar()">
        <section class="landing">
            <h2>CMA Registration</h2>
            <p>Join CMA and learn who they are, and what they do.</p>
        </section>

        <section class="group-form">
            <h3>Register for CMA Group</h3>
            <form action="cma-register.php" method="POST" enctype="multipart/form-data">
