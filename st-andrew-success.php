...
<body>
    <header>
        ...
        <h1>Subscribe to Saint Andrew Jumuiya Below</h1>
    </header>
    ...
    <section class="landing">
        <h2>Saint Andrew Community </h2>
        <p>You will receive reminder emails and other secasa emails upon subscribing.</p>
    </section>

    <section class="group-form">
        <h3>Subscribe to Saint Andrew Jumuiya Below</h3>
        ...
        if (isset($_POST['subscribe'])) {
            ...
            $stmt = $conn->prepare("SELECT * FROM staugustine WHERE email = ?");
        ...
        <form action="standrewemail.php" method="POST">
