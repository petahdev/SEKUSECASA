...
body {
    ...
    background: url('images/rosary.jpg') no-repeat center center fixed; 
...
<body>
    ...
    <div class="landing-content">
        <h1 class="heading">Welcome to CLA</h1>
    </div>
    <main onclick="closeSidebar()">
        <section class="landing">
            <h2>CLA Registration</h2>
            <p>Join CLA and learn who we are, and what we do.</p>
        </section>

        <section class="group-form">
            <h3>Register for CLA Group</h3>
            <form action="cla-register.php" method="POST" enctype="multipart/form-data">
