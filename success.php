...
body {
    ...
    background: url('images/rosary3.jpg') no-repeat center center fixed; /* Fixed background */
...
<body>
    ...
    <section class="landing">
        <h2>Saint Paul Community</h2>
        <p>Learn more about our jumuiya, contacts, and what we do.</p>
    </section>

    <section class="group-form">
        <h3>Register for Saint Paul</h3>
